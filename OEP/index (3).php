			...
			<div class="modal-body">
				...
				<form class="form-horizontal" action="" method="post" name="login">   
					...
					<div class="form-group">     
						...
						<div class="col-sm-9">        
							<input type="password" class="form-control" id="pwd" name="p1" placeholder="Enter Password"><input type="checkbox" onChange="showpass(1)" >Show Password   
						</div>   
					</div>     
					<div class="form-group">      
						<div class="col-sm-offset-2 col-sm-10">      
							<input type="submit" class="btn btn-default" name="f1b1" value="Log-in">  
						</div>   
					</div> 
				</form>
			</div>
				...
				<form name="f1" class="form-horizontal" method="post" action="SignUp.php">
					...
					<div class="form-group">     
						...
						<div class="col-sm-9">       
							...
							<input type="checkbox" onChange="showpass(2)" >Show
						</div>   
					</div>
					<div class="form-group">     
						...
						<div class="col-sm-9">       
							...
							<input type="checkbox" onChange="showpass(3)" >Show 
						</div>   
					</div>
					<div class="form-group">      
						<div class="col-sm-offset-2 col-sm-10">      
