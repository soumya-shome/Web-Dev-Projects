...
<body>
<div class="row">
<div class="col-md-12"><img src="carousel-banner-2.jpg" alt="" width="1000"></div>
</div>
...
<li class="#"><a href="#">CREATE QUES_SET</a></li>
<li class="#"><a href="#">ADD QUES</a></li>
<li class="#"><a href="#">VIEW QUES_PAPER</a></li>
<li class="#"><a href="#">CHANGE PASSWORD</a></li>
<li class="#"><a href="#">EDIT ST_DETAILS</a></li>
</ul>
...
<img src="home-carousel-23.jpg" alt="Carousal" class="img-responsive">
</div>


<div class="item">
<img src="home-carousel-10.jpg" alt="Carousal" class="img-responsive">
</div>
