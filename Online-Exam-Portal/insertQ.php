...
<div>
	<?php
$re="INSERT INTO `paper`(`p_code`, `p_name`, `set_no`, `c_id`, `time`, `no_of_q`) VALUES ('".$_SESSION['pco']."','".$_SESSION['pname']."','".$_SESSION['set']."','".$_SESSION['cc']."',".$_REQUEST['t3'].",".$_REQUEST['t2'].")";
					//INSERT INTO `paper` (`p_code`, `p_name`, `set_no`, `c_id`, `time`, `no_of_q`) VALUES ('P1001B', 'php', '2', '\'C1001', '2', '3');
